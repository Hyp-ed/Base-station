            ...
            if (confirmation.equals("0")) {
                ...
                while (true) {
                    for (int x = 0; x < 1000; x++) {
                        ...
                        dummydata.println("CMD07"+Integer.toString((x-10) % 70)); // vel
                        dummydata.println("CMD08"+Integer.toString(x-33)); // accel
                        ...
                        dummydata.println("CMD12"+Integer.toString(x % 90)); // hp temp
                        ...
                        dummydata.println("CMD18"+Integer.toString(x % 90)); // hp temp 1
                        ...
                        dummydata.println("CMD27"+Integer.toString(x % 5000)); // RPM FL
                        dummydata.println("CMD28"+Integer.toString(x % 5000)); // RPM FR
                        dummydata.println("CMD29"+Integer.toString(x % 5000)); // RPM BL
                        dummydata.println("CMD30"+Integer.toString(x % 5000)); // RPM BR
